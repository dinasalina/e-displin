<aside :class="sidebarOpen ? 'w-64' : 'w-20'" 
    ...
    <div class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        ...
        <!-- Log Audit AI -->
        <a href="{{ route('ai.history') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl font-medium text-xs sm:text-sm {{ request()->routeIs('ai.history') ? 'bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-900/60' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700/50 hover:text-slate-900 dark:hover:text-slate-100' }} transition-colors">
            ...
            <span x-show="sidebarOpen" class="truncate">Log Audit AI</span>
        </a>
