...
use App\Http\Controllers\Ai\AiInsightController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Modul 3: AI Predictive Analytics & Audit History
    Route::prefix('ai')->name('ai.')->group(function () {
        Route::post('/generate', [AiInsightController::class, 'generate'])->name('generate');
        Route::get('/history', [AiInsightController::class, 'history'])->name('history');
    });
});
